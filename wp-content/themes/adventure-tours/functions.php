...
define( 'ADVENTURE_TOURS_VERSION', '4.1.5.1' );
...
function register_post_types(){
    ...
    register_post_type( 'chartavia-events', [
        'label'  => null,
        'labels' => [
            'name'               => 'Чартерные рейсы', // основное название для типа записи
            'singular_name'      => 'Чартерные рейсы', // название для одной записи этого типа
            'add_new'            => 'Добавить рейс', // для добавления новой записи
            'add_new_item'       => 'Добавление рейса', // заголовка у вновь создаваемой записи в админ-панели.
            'edit_item'          => 'Редактирование рейса', // для редактирования типа записи
            'new_item'           => 'Новый рейс', // текст новой записи
            'view_item'          => 'Смотреть рейс', // для просмотра записи этого типа.
            'search_items'       => 'Искать рейс', // для поиска по этим типам записи
            'not_found'          => 'Не найдено', // если в результате поиска ничего не было найдено
            'not_found_in_trash' => 'Не найдено в корзине', // если не было найдено в корзине
            'parent_item_colon'  => '', // для родителей (у древовидных типов)
            'menu_name'          => 'Чартерные рейсы', // название меню
        ],
        'description'         => '',
        'public'              => true,
    ...
    register_post_type( 'avia-events', [
        'label'  => null,
        'labels' => [
            'name'               => 'Авиарейс', // основное название для типа записи
            'singular_name'      => 'Авиарейс', // название для одной записи этого типа
            'add_new'            => 'Добавить рейс', // для добавления новой записи
            'add_new_item'       => 'Добавление рейса', // заголовка у вновь создаваемой записи в админ-панели.
            'edit_item'          => 'Редактирование рейса', // для редактирования типа записи
            'new_item'           => 'Новый рейс', // текст новой записи
            ...
            'not_found_in_trash' => 'Не найдено в корзине', // если не было найдено в корзине
            'parent_item_colon'  => '', // для родителей (у древовидных типов)
            'menu_name'          => 'Авиарейс', // название меню
        ],
        'description'         => '',
        'public'              => true,
        // 'publicly_queryable'  => null, // зависит от public
...
function woo_custom_redirect_after_purchase() {
    ...
    if ( is_checkout() && !empty( $wp->query_vars['order-received'] ) ) {
        wp_redirect( get_home_url() . '/thank-you-page/' );
        exit;
    }
}
