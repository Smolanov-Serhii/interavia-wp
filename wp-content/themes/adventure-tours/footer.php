    ...
    <div class="conteiner">
        <div class="footer__wrap__columns">
            ...
            <div class="footer__column">
                <?php
                if(get_field('telefon_1', 'options')){
                    ?>
                ...
                ?>
                <?php
                if(get_field('telefon_2', 'options')){
                    ?>
                    <a href="tel:<?php echo the_field('telefon_2', 'options') ?>"><?php echo the_field('telefon_2', 'options') ?></a>
                    <?php
                }
                ?>
                <a href="https://api.whatsapp.com/send?phone=79153848648&text=%D0%94%D0%BE%D0%B1%D1%80%D1%8B%D0%B9%20%D0%B4%D0%B5%D0%BD%D1%8C%2C%20%D1%8F%20%D0%BF%D0%BE%20%D0%BF%D0%BE%D0%B2%D0%BE%D0%B4%D1%83%20%D0%B1%D0%B8%D0%BB%D0%B5%D1%82%D0%BE%D0%B2">WhatsApp
                </a>

                <a href="mailto:<?php echo the_field('pochta_dlya_sajta', 'options') ?>"><?php echo the_field('pochta_dlya_sajta', 'options') ?></a>
            </div>
            <div class="footer__icons">
                <?php
                $telega = get_field('ssylkka_na_telegram', 'options');
                if($telega){
                    ?>
                    <a href="<?php echo $telega; ?>">
                ...
                <?php
                    $vk = get_field('ssylka_na_vk', 'options');
                    if($vk){
                        ?>
                        <a href="<?php echo $vk; ?>">
                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                ?>
                <?php
                $insta = get_field('ssylka_na_instagramm', 'options');
                if($insta){
                    ?>
        ...
        <div class="footer__copyright">
            <p>Interaviacentr © Интравиасервивис, <?php echo date("Y")?>. Все права защищены. Пользовательское соглашение Соглашение об обработке персональных данных. 12+</p>
        </div>
    </div>
</footer>
